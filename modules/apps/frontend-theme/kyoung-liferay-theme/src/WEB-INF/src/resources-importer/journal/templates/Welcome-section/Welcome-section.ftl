   ...
   <div class="container">
      ...
      <div class="header-featured-content">
         ...
         <div class="app-download-area">
            ...
            <#if WelcomeDownloadText.getSiblings()?has_content><#list WelcomeDownloadText.getSiblings() as cur_WelcomeDownloadText> <a class="apple-btn" href="#"><i class="fa ${cur_WelcomeDownloadText.WelcomeDownloadLogo.getData()}"></i><span>${cur_WelcomeDownloadText.getData()}</span></a></#list> </#if> 
         </div>
      </div>
   </div>
</div>